-- Create a security definer function to fetch company portfolio with creator/editor names
...
AS $$
  SELECT
    ...
    cp.created_by,
    cp.updated_by,
    COALESCE(p1.full_name, '') AS creator_name,
    COALESCE(p2.full_name, '') AS editor_name
